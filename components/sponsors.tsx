        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              <a className={linkClassName} href="https://www.zone2.tech/">
                Zone 2
              </a>{" "}
              is backing the project. We recommend their services.
            </p>
          </div>
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              {" "}
                              Your partner in Keycloak deployment,
                              configuration, and extension development for
                              optimized identity management solutions.{" "}
                            </p>
                          </div>
                        </div>
                        <div>
